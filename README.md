...
See `docs/SPEC.md` §13: β, the gas deposit amount, the oracle's gas stipend and thresholds, DARLI supply and distribution, persistent failure in the shared settlement path, and legal review before any deployment.
